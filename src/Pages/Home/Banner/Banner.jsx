    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center h-full left-0 top-0 right-5 bg-linear-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className="text-white space-y-7 pl-14 w-1/2">
                        ...
                        <div>
                        <button className="btn btn-outline btn-accent mr-5">Discover More</button>
